...
namespace omarkhd.Gymk
{
	public partial class GymkWindow
	{
		...
		private global::Gtk.Action CatlogosAction1;
		...
		protected virtual void Build ()
		{
			...
			this.ConfigAction = new global::Gtk.Action ("ConfigAction", global::Mono.Unix.Catalog.GetString ("Configuración"), null, null);
			...
			this.CatlogosAction1 = new global::Gtk.Action ("CatlogosAction1", global::Mono.Unix.Catalog.GetString ("Catálogos"), null, null);
			this.CatlogosAction1.ShortLabel = global::Mono.Unix.Catalog.GetString ("Catálogos");
			w1.Add (this.CatlogosAction1, null);
			...
			this.UIManager.AddUiFromString (@"<ui><menubar name='menubar2'><menu name='ArchivoAction' action='ArchivoAction'><menu name='addAction' action='addAction'><menuitem name='NewEnrollmentAction' action='NewEnrollmentAction'/><menuitem name='NewClientAction' action='NewClientAction'/></menu><menuitem name='QuitAction' action='QuitAction'/></menu><menu name='EditarAction' action='EditarAction'><menu name='CatlogosAction1' action='CatlogosAction1'><menuitem name='AreasAction' action='AreasAction'/><menuitem name='PacksAction' action='PacksAction'/></menu><menuitem name='ConfigAction' action='ConfigAction'/></menu></menubar></ui>");
